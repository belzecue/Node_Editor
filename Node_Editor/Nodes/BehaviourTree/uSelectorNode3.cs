...
[System.Serializable]
[Node (false, "BehaviourTree/SelectorNode/3")]
public class uSelectorNode3 : uBehaviourTreeNode {
	public const string ID = "SelectorNode3";
	...
	public uSelectorNode3(){
		nodeType = NodeType.SelectorNode;
	}

	public override Node Create (Vector2 pos) 
	{
		var node = CreateInstance <uSelectorNode3> ();
