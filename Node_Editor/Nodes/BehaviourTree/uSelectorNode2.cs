...
[System.Serializable]
[Node (false, "BehaviourTree/SelectorNode/2")]
public class uSelectorNode2 : uBehaviourTreeNode {
	public const string ID = "SelectorNode2";
	...
	public uSelectorNode2(){
		nodeType = NodeType.SelectorNode;
	}

	public override Node Create (Vector2 pos) 
	{
		var node = CreateInstance <uSelectorNode2> ();
