...
[System.Serializable]
[Node (false, "BehaviourTree/SequencerNode/2")]
public class uSequencerNode2 : uBehaviourTreeNode {
	public const string ID = "SequencerNode2";
	...
	public uSequencerNode2(){
		nodeType = NodeType.SequencerNode;
	}

	public override Node Create (Vector2 pos) 
	{
		var node = CreateInstance <uSequencerNode2> ();
